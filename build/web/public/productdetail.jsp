    ...
    <body>
            ...
            <c:if test="${not empty product}">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="color-dropdowns">
                            <div id="colorOptions">
                                <c:forEach var="entry" items="${groupedByColor}">
                                    <div class="color-option" data-color="${entry.key}" onclick="selectColor(this)" style="height: 45px;width:45px">
                                    ...
                                    <div class="size-options" data-color="${entry.key}" style="display: none;">
                                        <c:forEach var="pi" items="${entry.value}">
                                            <div class="size-option" data-size="${pi.size}" data-stock="${pi.stockcount}" onclick="selectSize(this)">
                                                ...
                                                <span id="discountIndicator" class="discount-indicator" style="display: none;"></span>
                                            </div>
                                        </c:forEach>
                                    </div>
                                </c:forEach>
                        ...
                        <button class="" onclick="addToCart()" style="width: 100px;height: 30px; margin-top: 20px">Add to Cart</button>
        ...
        <script>
            ...
            function addToCart() {
                ...
                console.log('Adding to cart: Color - ' + selectedColor + ', Size - ' + selectedSize + ', PIID - ' + piid + ', Quantity - ' + quantity);
                alert('Adding to cart: PIID - ' + piid);
